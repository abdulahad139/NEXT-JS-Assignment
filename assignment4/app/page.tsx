...
export default function HomePage() {
  ...
  <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
    ...
    <div className="md:w-2/3 text-center md:text-left">
      <h1 className="text-4xl font-bold mb-4">Hi, I am Abdul Ahad,<br />Creative Technologist</h1>
      <p className="text-gray-600 mb-6">I am an Aspiring Data Scientist working with diverse real-world data to make better decisions for businesses.</p>
